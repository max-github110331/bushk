...
class ETA:
    ...
    def get_stop(stop: abcStop):
        ...
        for _route_data in _data["data"]:
            _list.append({"route": _route_data["route"], "bound": _route_data["bound"], "service_type": _route_data["service_type"], "arrive_at": _data["eta"].replace("T", " ")[:-6], "rmk": {"tc": _data["rmk_tc"], "sc": _data["rmk_sc"], "en": _data["rmk_en"]}})